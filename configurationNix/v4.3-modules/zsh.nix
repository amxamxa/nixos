...
# wird bei Initialisierung einer interaktiven Zsh-Shell ausgeführt. (Interaktive Shells sind die Shells, mit denen Benutzer direkt interagieren.)
  export	VISUAL="$EDITOR";
  	...
  	export	BAT_WRAP_AT=100;
	source ${pkgs.nix-index}/etc/profile.d/command-not-found.sh         
		export HISTIGNORE="ls:cd:pwd:exit:tldr:cheat:navi"
...
#	  	  shellAliases = "$ZDOTDIR/aliases.zsh";
		  ...
		  setOptions = [		# see man 1 zshoptions
			...
			"AUTO_CD"			"NOMATCH"		
"HIST_IGNORE_DUPS"      # Doppelte Einträge vermeiden
 "HIST_IGNORE_SPACE"     # Leerzeichen-Befehle ignorieren
 "INC_APPEND_HISTORY"    # History sofort speichern
