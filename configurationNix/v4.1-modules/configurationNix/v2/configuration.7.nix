...
#i18n.inputMethod.fcitx5.waylandFrontend
 ...
 # desktopManager + WindoManager 
#services.xserver.displayManager.defaultSession = "gnome"; # + bspwm"; #define your default window manager and desktop environment"xfce";
...
#nixpkgs.config.allowBroken = true; # für nvidia 390
...
#BROKEN: linuxKernel.packages.linux_latest_libre.nvidia_x11_legacy390
...
#ACPI
#microcodeIntel
#ntel-gmmlib #Intel Graphics Memory Management Library
#ntel-ocl #Official OpenCL runtime for Intel CPUs
# linuxKernel.packages.linux_latest_libre.intel-speed-select # is marked as broken, refusing to evaluate.
#linuxKernel.packages.linux_latest_libre.asus-ec-sensors
#linuxKernel.packages.linux_latest_libre.acpi_call #A module allowing arbitrary ACPI calls; use case: hybrid video
#acpitool #small, convenient command-line ACPI client with a lot of features
