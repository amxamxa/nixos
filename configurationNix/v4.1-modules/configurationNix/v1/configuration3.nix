...
boot.loader.efi.efiSysMountPoint = "/boot/efi"; # Strings are enclosed in double quotes

# GRUB2
boot.loader.grub.enable = true;
boot.loader.grub.efiSupport = true;
boot.loader.grub.device = "/dev/disk/by-uuid/ACD7-8E7C"; #["nodev"];
...
#                '';        ##''Multi-line strings double single quotes, 
#};
...
# Enable the X11 windowing system.
  ...
  # Intel Graphics drivers in X.org
  services.xserver.videoDrivers = [ "modesetting" ];
### ### DeM -  d e s k t o p  m a n a g e r ### ###
...
#### DiM -  d i s p l a y   m a n a g e r
