...
environment.systemPackages = with pkgs; [
	...
	#nomeExtensions.burn-my-windows
	...
	tree
	neofetch
	hyfetch # main purpose of HyFetch is to be used in screenshots 
	perl
	micro
	#fzf-zsh
	#fzf
	...
	fortune
	clolcat
	blahaj #gay sharks at your local terminal - lolcat-like CLI tool
	...
	exa # modern replacement for ls. It uses colours for information by default,
