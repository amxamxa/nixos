...
*/
 ...
 hardware.opengl.extraPackages  	= true;
 hardware.opengl.extraPackages32 	= true;
  # 	hardware.opengl.extraPackages   = with pkgs.pkgsi686Linux; [ intel-vaapi-driver ];
#	hardware.opengl.extraPackages32 = with pkgs.pkgsi686Linux; [ intel-vaapi-driver ]; # used to add OpenCL drivers, VA-API/VDPAU 
...
# nixpkgs.config.allowBroken = true;
   ...
   # Sudoers - I/O plugin version 1.9.15p2  Sudoers - audit plugin version 1.9.15p2
   	security.sudo = {
        ...
        environment.variables = {	/* env var used in the global environment. 
...
# 	xfce.xfce4-weather-plugin
  ...
  # swayfx sway swaysettings sway-launcher-desktop #    TUI Application launcher with Desktop Entry support.
