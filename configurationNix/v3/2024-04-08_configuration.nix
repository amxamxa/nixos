...
#  	fsIdentifier = "label";
  ...
  splashImage ="/boot/grub/grub-sw.png"; # background image used for GRUB. Set to null to run GRUB in text mode.
 	splashMode = "normal"; # "stretch"; # oder normal
  	font = "/boot/grub/fonts/cir.pf2"; # Path to a TrueType, OpenType, or pf2 font to be used by Grub.
  	fontSize = 24; # ...wird ignoriert, es sei denn, die Schriftart ist auf eine TTF- oder OTF-Schriftart eingestellt.
 	extraConfig = ''
  	#set background_image="/boot/grub/grub-sw.png"
 	set color_normal=green
   				'';
...
# Enable the XFCE Desktop Environment.
 services.xserver.displayManager.lightdm = {
	enable = true;
	background = "/boot/grub/grub-sw.png";
...
# service for xfce display magmt
 ...
 # Enable sound with pipewire.
  ...
  services.pipewire = {
   ...
   services.pipewire.wireplumber.enable = true; # a modular session / policy manager for PipeWire
...
#------------------------------------
	...
	xfce.xfce4-fsguard-plugin # monitors the free space on your filesystems
...
##		GUI internet tools
	...
	gnome.gnome-disk-utility 	gnome-text-editor
