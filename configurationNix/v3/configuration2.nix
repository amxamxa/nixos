...
#GPU und so
  ...
  services.xserver = {
    layout = "de";
    xkbVariant = "";
    #   xkbOptions = "eurosign:e,caps:escape";# oder "terminate:ctrl_alt_bksp"; # oder "grp:caps_toggl>
  };
...
# enable lightdm as DM 
  ...
  # services.xserver.displayManager.lightdm.background  = "pkgs.nixos-artwork.wallpapers.simple-dark-g>
  ...
  services.xserver.displayManager.lightdm.greeters.slick.iconTheme.package = pkgs.gnome.adwaita-icon-t>
...
####i3 -better compatibility w/ Xorg - tiling window manager that focuses on efficiency and productivi>
...
### bspwm: bspwm steht für "binary space partitioning window manager" und ist ein tiling window manage>
