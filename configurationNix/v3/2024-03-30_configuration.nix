...
#boot.loader.grub.backgroundColor  = "#7EBAE4"; # background color to be used to fill the areas the image isn’t filling.
 boot.loader.grub.splashImage ="./grub-sw.png" # background image used for GRUB. Set to null to run GRUB in text mode.
 boot.loader.grub.splashMode = "stretch"; # oder normal
 boot.loader.grub.font = "./neo.ttf"; # Path to a TrueType, OpenType, or pf2 font to be used by Grub.
 boot.loader.grub.fontSize = 18; # ...wird ignoriert, es sei denn, die Schriftart ist auf eine TTF- oder OTF-Schriftart eingestellt.
