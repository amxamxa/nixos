...
emacsPackages.pbcopy # Enables the Emacs kill-ring to interact with the clipboard 
qemu
	###		EFI boot tools
	grub2
	memtest86-efi
...
#	nix-plugins   	nix-top   	nix-template  
	...
	xclip # Einfache Manipulation der X11-Zwischenablage über die Kommandozeile
	#xsel # Umfangreichere Syntax, Unterstützung für primäre, sekundäre und Clipboard-Auswahl, Bietet mehr Optionen und Flexibilität als xclip
