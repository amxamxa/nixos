...
# FYI: Zeichenkombinationen wie !=, >=, ==, -> oder := verwendet. Ligaturen wandeln diese Zeichenfolgen in einzelne, zusammenhängende Symbole um (z. B. ≠, ≥, ≡) 
{
  ...
  fonts = {
    ...
    fontconfig = {
      ...
      # Font-Filter für GohuFont
      localConf = ''  
        <?xml version="1.0"?>
        <!DOCTYPE fontconfig SYSTEM "fonts.dtd">
        <fontconfig>
          <!-- Nur GohuFont 11/14 Nerd Font Mono erlauben -->
          <selectfont>
            <rejectfont>
              <pattern>
              ...
              <except>
                <pattern>
                  <patelt name="family"><string>GohuFont 11 Nerd Font Mono</string></patelt>
                </pattern>
                <pattern>
                  <patelt name="family"><string>GohuFont 14 Nerd Font Mono</string></patelt>
                </pattern>
              </except>
            </rejectfont>
          </selectfont>

          <!-- Deine bestehenden Aliase -->
          <alias>
